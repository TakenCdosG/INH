...
<div class="calendar-tab-item" >
    <div class="calendar-tab-item-title"><a href="<?php print $fields['field_url_event']->content; ?>" target="_blank"><?php print $format; ?></a></div>
    <?php if ($src != "") { ?>
        <div class="calendar-tab-item-img">
            <a href="<?php print $fields['field_url_event']->content; ?>" target="_blank"><img src="<?php print $src ?>" width="90" />
            </a>
        </div>
    <?php } ?>

    <div class="calendar-tab-item-text">
